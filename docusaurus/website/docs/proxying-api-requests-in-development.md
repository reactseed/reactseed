...
By default, `Reactseed` using [mocker-api](https://www.npmjs.com/package/mocker-api) handle proxies.

You can now register proxies as you wish! Here's an example using the above `mocker-api`:
...
Now you can get proxy data by visiting [localhost:3000/api/app](localhost:3000/api/app).
