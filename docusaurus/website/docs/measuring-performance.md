...
By default, `Reactseed` includes a performance relayer that allows you to measure and analyze
...
experience of a web page. In `Reactseed`, a third-party library is used to measure these
